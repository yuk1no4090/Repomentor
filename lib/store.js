...
// ── Record normalizers owned by server.js ──
...
// sub-collections to helper functions that belong to server.js's auth/
// preferences/memory-suggestion/harness domains (out of scope for this
// storage-layer split; see refactor report). Since lib modules may not import
// from server.js (that would create server.js -> lib/store.js -> server.js
// cycle), server.js injects those helpers once at startup via
